	...
	<div class="modal-dialog modal-dialog-scrollable">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="{{ route('cash-transaction-expenditures.store') }}" method="POST" id="addCashTransactionForm">
					@csrf
					{{-- <div class="row">
						<div class="col-md-12">
							<div class="mb-3">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="mb-3">
								...
								<input type="number" class="form-control @error('expenditure') is-invalid @enderror" name="expenditure"
									value="{{ old('expenditure') }}" id="expenditure" placeholder="Masukkan tagihan..">
