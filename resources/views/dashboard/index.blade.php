...
<section class="row">
	<div class="col-12 col-lg-12">
		<div class="row">
					...
					<div class="card card-stat">
						<div class="card-body px-3 py-4-5">
							<div class="row">
								...
								<div class="col-md-8">
									<h6 class="text-muted font-semibold">Saldo Bulan Ini</h6>
									<h6 class="font-extrabold mb-0">
										{{ $amountBalanceThisMonth }}
									</h6>
								</div>
							</div>
						</div>
			...
			<div class="col-6 col-lg-3 col-md-6">
				<a href="{{ route('cash-transaction-expenditures.index') }}">
					<div class="card card-stat">
						<div class="card-body px-3 py-4-5">
							<div class="row">
								<div class="col-md-4">
								...
								<div class="col-md-8">
									...
									<h6 class="font-extrabold {{ $schoolMajorCount <= 0 ? 'text-danger' : '' }} mb-0">
										<h6 class="font-extrabold mb-0">{{ $amountCashTransactionExpenditureThisMonth }}</h6>
									</h6>
								</div>
							</div>
						</div>
					...
					<div class="card card-stat">
						<div class="card-body px-3 py-4-5">
							<div class="row">
								...
								<div class="col-md-8">
									<h6 class="text-muted font-semibold">Pemasukan Kas Bulan Ini</h6>
									<h6 class="font-extrabold mb-0">{{ $amountCashTransactionThisMonth }}</h6>
								</div>
							</div>
						</div>
					</div>
