...
class DashboardChartRepository extends Controller implements ChartInterface, ChartExpendituresInterface 
{
    public function __construct(
        private CashTransaction $model,
        private CashTransactionExpenditure $modelExpenditure,
    ) {
    }
    ...
    public function sumCashTransactionExpenditurePerMonths(): array
    {
        ...
        for ($i = 1; $i <= 12; $i++) {
            ...
            $cashTransactionExpenditures = $this->modelExpenditure
